...
const freelancers = [
  {
    ...
    reviews: 127,
    hourlyRate: 15000,
    skills: ["Logo Design", "Branding", "Photoshop", "Illustrator"],
...
2. Create a branch with your name (hyphen(-) separated, all lowercase)
...
5. Push to GitHub and share the repository link
